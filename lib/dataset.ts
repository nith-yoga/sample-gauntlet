...
const tier2Data: TrackData[] = [
  { id: 201, tier: 2, sample: { videoId: "t7SvtikTkrM", startSeconds: 0, originalArtist: "The Clash", originalTrack: "Straight to Hell" }, flip: { artist: "M.I.A.", track: "Paper Planes", videoId: "s9M2JQTDjiA", startSeconds: 0, alternates: ["MIA"] } },
...
const tier4Data: TrackData[] = [
  ...
  { id: 409, tier: 4, sample: { videoId: "G11KG_lfx5o", startSeconds: 12, originalArtist: "The Dells", originalTrack: "Does Anybody Know I'm Here" }, flip: { artist: "J Dilla", track: "Over the Breaks", videoId: "HSn--s4Bj_M", startSeconds: 0, alternates: [] } },
